...
Route::prefix('dashboard')->middleware(['auth','role:Admin'])->group(function () {
    ...
    Route::get('/daftar-transaksi-selesai',[DashboardAdminController::class,'transaksi_selesai'])->name('admin.riwayat_transaksi');
    Route::get('/daftar-transaksi-selesai/export',[DashboardAdminController::class,'transaksi_export'])->name('admin.export_transaksi');
