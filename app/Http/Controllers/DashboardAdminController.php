...
class DashboardAdminController extends Controller
{
    ...
    {
        $transaksi = Transaksi::with(['User','Teknisi','Layanan'])->where('status','=','selesai')->get();
        ...
        return view('dashboard.admin.riwaya=-c=-t-pemesanan.riwayat-index');
    }

    public function transaksi_export(Transaksi $transaksi)
    {
        return Excel::download(new RiwayatExport($transaksi), 'riwayat_pemesanan.xlsx');
    }
}
